# Jekflix Template
![Cover Image](https://res.cloudinary.com/dm7h7e8xj/image/upload/v1505354182/jekflix-logo_mfngps.png)

See the [demo here](https://rossener.com/jekflix-pro-template).
...
![Screenshot](https://res.cloudinary.com/dm7h7e8xj/image/upload/v1505357238/jekflix-screenshot_qikqkl.jpg)
...
- Reading Progress Bar
 ...
 ![Progress Bar](https://res.cloudinary.com/dm7h7e8xj/image/upload/v1505357769/jekflix-progress-bar_he7gqf.jpg)
- "New Post" tag
...
1. Fork the [Jekflix Template](https://github.com/thiagorossener/jekflix-pro-template/fork)
...
You have to fill some informations on `src/yml/settings.yml` to customize your site.
...
url: "https://rossener.com" # the base hostname & protocol for your site
...
Fill the social information on `src/yml/social.yml`.
...
All theme color customization are in `src/yml/theme.yml`.
...
File a [GitHub Issue](https://github.com/thiagorossener/jekflix-pro-template/issues/new) please.

## Author

[Thiago Rossener](https://rossener.com/) based on [Cards Jekyll Template](https://github.com/willianjusten/cards-jekyll-template).
