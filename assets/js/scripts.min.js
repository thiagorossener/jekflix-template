...
!function(){"use strict";var e=document.querySelector(".post-content"),m=document.querySelector(".progress-bar");if(e&&m){var p=0,y=e.scrollHeight,g=m.querySelector(".completed"),S=m.querySelector(".remaining"),v=m.querySelector(".time-completed"),I=m.querySelector(".time-remaining");document.addEventListener("scroll",function(){var e=window.pageYOffset||document.documentElement.scrollTop;if(m.style.bottom=p<e?"0%":"-100%",e<=y){var t=e/y,r=(100*t).toFixed(2),n=100-parseFloat(r);g.style.width=r.toString()+"%",S.style.width=n.toString()+"%";var i=60*parseInt(m.getAttribute("data-minutes")),o=parseInt(t*i),s=parseInt(o/60),a=parseInt(60*(o/60-s)),l=i-o,c=parseInt(l/60),u=parseInt(60*(l/60-c));s=s<10?"0"+s:s,a=a<10?"0"+a:a,c=c<10?"0"+c:c,u=u<10?"0"+u:u,v.innerText=s+":"+a,I.innerText=c+":"+u}else{g.style.width="100%",S.style.width="0%";var d=parseInt(m.getAttribute("data-minutes"));d=d<10?"0"+d:d,v.innerText="00:00",I.innerText=d+":00"}p=e})}}();
...
!function(c){c.fn.simpleJekyllSearch=function(e){var a=c.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}"><span class="entry-category">{categories}</span> {title} <span class="entry-date"><time datetime="{date}">{date}</time></span></a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Puuuts! Não encontramos nada :(</p>"},e),l=a.jsonFormat.split(","),o=[],s=this,i=c(a.searchResults);function r(){i.children().remove()}a.jsonFile.length&&i.length&&c.ajax({type:"GET",url:a.jsonFile,dataType:"json",success:function(e,t,n){o=e,s.keyup(function(e){var t,n,s;c(this).val().length?(n=c(this).val(),s=[],c.each(o,function(e,t){for(e=0;e<l.length;e++)void 0!==t[l[e]]&&-1!==t[l[e]].toLowerCase().indexOf(n.toLowerCase())&&(s.push(t),e=l.length)}),t=s,r(),i.append(c(a.searchResultsTitle)),t.length?c.each(t,function(e,t){if(e<a.limit){for(var n=a.template,e=0;e<l.length;e++){var s=new RegExp("{"+l[e]+"}","g");n=n.replace(s,t[l[e]])}i.append(c(n))}}):i.append(a.noResults)):r()})},error:function(e,t,n){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(t),console.log(n)}})}}(Zepto);
...
!function(a,e,o){a("#menu").click(function(){a("body").addClass("push-menu-to-right"),a("#sidebar").addClass("open"),a(".overlay").addClass("show")}),a("#mask").click(function(){a("body").removeClass("push-menu-to-right"),a("#sidebar").removeClass("open"),a(".overlay").removeClass("show")});var s={close:a(".icon-remove-sign"),searchform:a(".search-form"),canvas:a("body"),dothis:a(".dosearch")};function r(){a(".search-wrapper").toggleClass("active"),s.searchform.toggleClass("active"),s.canvas.removeClass("search-overlay")}s.dothis.on("click",function(){a(".search-wrapper").toggleClass("active"),s.searchform.toggleClass("active"),s.searchform.find("input").focus(),s.canvas.toggleClass("search-overlay"),a(".search-field").simpleJekyllSearch()}),s.close.on("click",r),document.addEventListener("keyup",function(e){27==e.keyCode&&a(".search-overlay").length&&r()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
