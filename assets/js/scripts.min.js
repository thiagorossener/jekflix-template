...
var likeButton=document.getElementById("like-button-container"),middlePosition=window.innerHeight/2,thresholdPercentage=85;function handleScroll(){var e=(document.documentElement.scrollHeight-window.innerHeight)*thresholdPercentage/100;window.scrollY>middlePosition&&window.scrollY<e?(likeButton.classList.add("visible"),likeButton.classList.remove("fixed")):window.scrollY>=e?(likeButton.classList.remove("visible"),likeButton.classList.add("fixed")):(likeButton.classList.remove("visible"),likeButton.classList.remove("fixed"))}window.addEventListener("scroll",handleScroll);
