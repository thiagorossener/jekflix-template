...
var likeButton=document.getElementById("like-button-container"),middlePosition=window.innerHeight/2;function handleScroll(){window.scrollY>middlePosition&&window.scrollY<document.body.scrollHeight-middlePosition?likeButton.classList.add("visible"):likeButton.classList.remove("visible")}window.addEventListener("scroll",handleScroll);
